...
def detect():
    ...
    #display_image(image_name)
    vector_speaks('I have detected few objects in front of me, and I can name them')
    vector_speaks('I detected {}'.format(text))
    vector_speaks('I Can detect around six hundred objects, and I use a object detection algorithm based on deep learning')
